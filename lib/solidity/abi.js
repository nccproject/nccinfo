...
const ncc20List = require('./ncc20-abi.json')
const ncc721List = require('./ncc721-abi.json')
...
const ncc20ABIs = transformABIList(ncc20List)
const ncc721ABIs = transformABIList(ncc721List)

Object.assign(exports, {MethodABI, EventABI, ncc20ABIs, ncc721ABIs})
